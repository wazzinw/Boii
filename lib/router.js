...
if (Meteor.isServer) {
    Meteor.startup(function() {
        ...
        Restivus.addRoute('restaurants', {authRequired: true}, {
            get:{
        ...
        Restivus.addRoute('restaurants/:id', {authRequired: true}, {
            action: function(){
        ...
        Restivus.addRoute('restaurants/:id/menus', {authRequired: true}, {
            action: function(){
                ...
                if(menuID_array = Restaurants.findOne({_id: this.params.id}).menu) {
